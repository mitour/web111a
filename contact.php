...
<div class="row justify-content-center">
  ...
  <section class="col-12 plain_block">
    <form class="form" action="/form.php" method="post">
      <div class="input-group flex my-2">
        <label for="username" class="form-label h3 col-3">Name: </label>
        <input type="text" class="form-control col-9" id="username" name="username" aria-describedby="icon-user">
      </div>
      <div class="input-group flex my-2">
        <label for="phone" class="form-label h3 col-3">Tel: </label>
        <input type="text" class="form-control col-9" id="phone" name="phone" aria-describedby="icon-phone">
      </div>
      <div class="flex my-2">
        <label for="opinion" class="form-label h3 col-3 ">您的意見：</label>
        <textarea class="form-control col-9" id="opinion" name="opinion" rows="5"
          placeholder="Describe your opinion"></textarea>
      </div>
      <div class="btn-group">
